defmodule HearkingstonWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(HearkingstonWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(HearkingstonWeb.Gettext, "errors", msg, opts)
    end
  end
